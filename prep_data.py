...
if os.path.exists('embeds.p'):
    ...
    sentence_embeddings = bert.encode(movies['overview'].tolist(), show_progress_bar=True)
...
# Save the data
data_to_dump = {'vote_count':np.float64(vote_count.tolist()), 'rating_embed':rating_embed, 'bert_embed':embeds_all,'titles':titles_all}
