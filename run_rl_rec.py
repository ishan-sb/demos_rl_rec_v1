...
idces_keep = np.where(vote_count>500)[0]  #Filter out the less popular movies because I don't know what they are
...
recmod = Model(input_dim, output_dim)  # recmod is a POLICY model.  For a given movie, it tells you the "score" of it being relevant
